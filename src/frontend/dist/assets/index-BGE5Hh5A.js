...
const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$q);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ChartPie = createLucideIcon("chart-pie", __iconNode$p);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg leading-tight", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#9AAAC0" }, children: "CyberShield AI • Real-time Protection" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 18, className: "text-gray-400" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-red-500" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-purple-300", children: "Protected" })
              ]
            }
          )
        ] })
...
const navItems = [
  { id: "dashboard", label: "Dashboard", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { size: 18 }) },
  {
    id: "analyze",
    label: "Analyze Message",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 18 })
  },
  { id: "image", label: "Image Upload", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { size: 18 }) },
  { id: "reports", label: "Reports", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 18 }) },
  { id: "helplines", label: "Helplines", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 18 }) }
];
function Sidebar({
  currentPage,
  onNavigate,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        className: `fixed md:static z-30 top-0 left-0 h-full w-64 flex flex-col transition-transform duration-300 ease-in-out ${isOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`,
        style: {
          background: "#0C1626",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 20, className: "text-white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-bold text-sm tracking-wide", children: "CyberShield AI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Protection System" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
            ...
            navItems.map((item) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${active ? "text-white" : "text-gray-400 hover:text-white hover:bg-white/5"}`,
                  style: active ? {
                    background: "linear-gradient(135deg, rgba(139,92,246,0.3) 0%, rgba(249,115,22,0.2) 100%)",
                    border: "1px solid rgba(139,92,246,0.3)"
                  } : {},
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: active ? "text-orange-400" : "", children: item.icon }),
                    item.label,
                    active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto w-1.5 h-1.5 rounded-full bg-orange-400" })
                  ]
                },
                item.id
              );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-white", children: "CyberShield AI" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "v2.1.0 Active" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto w-2 h-2 rounded-full bg-green-400 animate-pulse" })
              ] })
            }
          )
        ]
...
function analyzeText(text) {
  ...
  const alreadyFlagged = /* @__PURE__ */ new Set();
  ...
  const positiveCount = POSITIVE_WORDS.filter(
  ...
  const confidence = isBullying ? Math.min(98, 60 + flaggedWords.length * 8 + totalWeight * 2) : Math.min(96, 70 + positiveCount * 5);
  let explanation = "";
  if (isBullying) {
    const cats = [
    ...
    explanation = "No harmful language detected. This message appears safe and does not contain cyberbullying content.";
  }
...
function buildHighlightedSegments(text, flaggedWords) {
...
function renderSegments(segments) {
  ...
  return segments.map((seg) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: seg.text }, key);
  });
}
function AnalyzeMessage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-4xl mx-auto", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 16, className: "text-purple-400" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-semibold", children: "Message Analyzer" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#9AAAC0" }, children: "AI-powered cyberbullying detection — 7 harm categories" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-2", style: { color: "#9AAAC0" }, children: "Try an example:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: exampleMessages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#4A6080" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                style: {
                  background: loading ? "rgba(139,92,246,0.4)" : "linear-gradient(135deg, #8B5CF6, #F97316)"
                },
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-4 border-purple-500/20" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full border-4 border-t-purple-500 animate-spin" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: "Processing Message" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "Running NLP analysis & keyword detection across 7 categories..." })
          ] })
        ]
      }
    ),
    result && !loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-2xl p-5 flex items-center gap-4",
          style: {
            background: result.isBullying ? "rgba(249,115,22,0.1)" : "rgba(34,197,94,0.1)",
            border: `1px solid ${result.isBullying ? "rgba(249,115,22,0.4)" : "rgba(34,197,94,0.4)"}`
          },
          children: [
            result.isBullying ? /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { size: 28, className: "text-orange-400 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 28, className: "text-green-400 shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `text-lg font-bold ${result.isBullying ? "text-orange-400" : "text-green-400"}`,
                  children: result.isBullying ? "⚠️ Cyberbullying Detected" : "✅ Safe Message"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", style: { color: "#9AAAC0" }, children: result.explanation })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Confidence" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-relaxed", style: { color: "#E7EEF8" }, children: renderSegments(result.highlightedSegments) }),
            result.flaggedWords.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "mt-4 pt-4",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: result.flaggedWords.map((fw) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `text-2xl font-bold ${result.sentiment === "Positive" ? "text-green-400" : result.sentiment === "Negative" ? "text-orange-400" : "text-yellow-400"}`,
                    children: result.sentiment
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm", style: { color: "#9AAAC0" }, children: [
                  result.sentimentScore.toFixed(0),
                  "% intensity"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: ["Positive", "Neutral", "Negative"].map((s) => {
                const score = s === result.sentiment ? result.sentimentScore : s === "Neutral" ? 50 - Math.abs(result.sentimentScore - 50) / 2 : 100 - result.sentimentScore - 10;
                const color = s === "Positive" ? "#22C55E" : s === "Negative" ? "#F97316" : "#EAB308";
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9AAAC0" }, children: s }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: Object.entries(result.categoryCounts).map(([cat, count]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#9AAAC0" }, children: CATEGORY_CONFIG[cat].label.split("/")[0] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "span",
                  {
                    ...
                    style: {
                      color: count > 0 ? CATEGORY_CONFIG[cat].color : "#4A6080"
                    },
                    children: [
                      count,
                      " ",
    ...
    history.filter((h) => h.source === "chat").length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16, className: "text-purple-400" }),
                ...
                showHistory ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 16, className: "text-gray-400" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 16, className: "text-gray-400" })
              ]
            }
          ),
          showHistory && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 pb-5 space-y-3", children: history.filter((h) => h.source === "chat").slice(0, 10).map((record) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `mt-1 w-2 h-2 rounded-full shrink-0 ${record.result.isBullying ? "bg-orange-500" : "bg-green-500"}`
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-white truncate", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `text-xs font-medium ${record.result.isBullying ? "text-orange-400" : "text-green-400"}`,
                        children: record.result.isBullying ? "Bullying" : "Safe"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", style: { color: "#4A6080" }, children: [
                      "• ",
                      record.timestamp
                    ] })
                  ] })
...
function StatCard({
  ...
  const displayValue = animated ? Number.isInteger(numericValue) ? counted : numericValue : value;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-xl", style: { background: gradient }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color }, children: icon }) }),
          delta && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-xs font-semibold px-2 py-1 rounded-lg ${deltaPositive ? "text-green-400 bg-green-400/10" : "text-orange-400 bg-orange-400/10"}`,
              children: delta
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-2xl font-bold text-white mb-1", children: [
          displayValue,
          suffix2
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#9AAAC0" }, children: title })
      ]
    }
  );
}
...
function Dashboard({ stats, feed, onNavigate }) {
  const bullyRate = (stats.bullyingDetected / stats.totalAnalyzed * 100).toFixed(1);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-white", children: "Overview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "Real-time cyberbullying detection metrics" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", style: { color: "#00C896" }, children: "System Active" })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          ...
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 20 }),
          color: "#60A5FA",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2", children: Object.entries(CATEGORY_CONFIG).map(([key, cfg]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold text-white leading-tight", children: cfg.label.split("/")[0] }) })
        ]
      },
      key
    )) }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 16, style: { color: "#FB923C" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Recent Activity" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: feed.slice(0, 8).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white truncate", children: item.text }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
                      item.isBullying ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "text-xs font-medium",
                          style: {
                            color: item.category ? CATEGORY_CONFIG[item.category].color : "#F97316"
                          },
                          children: item.category ? CATEGORY_CONFIG[item.category].label : "Bullying Detected"
                        }
                      ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      style: {
                        background: item.isBullying ? "rgba(249,115,22,0.15)" : "rgba(0,200,150,0.15)",
                        color: item.isBullying ? "#F97316" : "#00C896"
                      },
                      children: item.isBullying ? "Alert" : "Safe"
                    }
                  )
                ]
              },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16, style: { color: "#F97316" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Quick Analyze" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-4", style: { color: "#9AAAC0" }, children: "Paste any message to instantly check for cyberbullying content." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-semibold text-sm mb-4", children: "Category Breakdown" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: CATEGORY_BREAKDOWN.map((item) => {
                const cfg = CATEGORY_CONFIG[item.key];
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9AAAC0" }, children: cfg.label.split("/")[0] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
...
const HOTLINES = [
  {
    ...
    contact: "988",
    contactType: "phone",
    description: "Free and confidential support for people in distress, 24/7 crisis support and prevention resources.",
    available: "24/7",
    color: "#EF4444",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 20 })
  },
  {
    name: "Crisis Text Line",
    contact: "Text HOME to 741741",
    contactType: "text",
    description: "Free, 24/7 text-based mental health support. Text-based crisis support for anyone in crisis.",
    available: "24/7",
    color: "#8B5CF6",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 20 })
  },
  {
    name: "Childhelp National Child Abuse Hotline",
    contact: "1-800-422-4453",
    contactType: "phone",
    description: "Professional crisis counselors available for abuse victims, parents, and witnesses.",
    available: "24/7",
    color: "#F97316",
  ...
  },
  {
    ...
    contactType: "phone",
    description: "Dedicated anti-bullying hotline providing support and resources specifically for youth bullying victims.",
  ...
  },
  {
    ...
    contactType: "phone",
    description: "National support line for bullying victims and parents seeking help and advice.",
    available: "24/7",
    color: "#22C55E",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20 })
  },
  {
    name: "Teen Line",
    contact: "1-800-852-8336",
    contactType: "phone",
    description: "Teen-to-teen peer support for youth experiencing bullying, depression, or crisis situations.",
  ...
  },
  {
    ...
    contactType: "web",
    description: "Research-based resources, guides, and tools for understanding and preventing cyberbullying.",
  ...
  },
  {
    ...
    contactType: "web",
    description: "Federal government resources for reporting cyberbullying and understanding legal protections.",
    available: "Online 24/7",
    color: "#A78BFA",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 20 })
  }
...
function Helplines() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "rounded-2xl p-6",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 24, className: "text-red-400" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-white mb-1", children: "Crisis Helplines & Resources" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "If you or someone you know is experiencing cyberbullying, reach out immediately. You are not alone. These resources provide free, confidential support." })
          ] })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-white font-semibold text-sm mb-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 16, className: "text-red-400" }),
        "Emergency Hotlines"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: HOTLINES.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: h.color }, children: h.icon })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-sm leading-snug", children: h.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: h.contactType === "phone" ? `tel:${h.contact.replace(/[^0-9]/g, "")}` : h.contactType === "web" ? `https://${h.contact}` : "#",
                target: h.contactType === "web" ? "_blank" : void 0,
                rel: h.contactType === "web" ? "noopener noreferrer" : void 0,
                ...
                children: [
                  h.contactType === "phone" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14 }),
                    " ",
                    h.contact
                  ] }),
                  h.contactType === "text" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 14 }),
                    " ",
                    h.contact
                  ] }),
                  h.contactType === "web" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-white font-semibold text-sm mb-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 16, className: "text-blue-400" }),
        "Online Resources"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: ONLINE_RESOURCES.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: `https://${r.url}`,
          target: "_blank",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 16, className: "text-blue-400" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-white", children: r.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs truncate", style: { color: "#9AAAC0" }, children: r.desc })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { size: 14, className: "text-gray-500 shrink-0" })
          ]
        },
        r.name
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: EMERGENCY_TIPS.map((tip) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-white mb-0.5", children: tip.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "text-xs",
...
const DANGER_COLOR$1 = "#F97316";
const SAFE_COLOR$1 = "#00C896";
function ImageUpload({ onAnalyze }) {
  ...
  const [loading, setLoading] = reactExports.useState(false);
  const [ocrText, setOcrText] = reactExports.useState(null);
  const [result, setResult] = reactExports.useState(null);
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { size: 16, style: { color: DANGER_COLOR$1 } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-white font-semibold", children: "Image Upload & Analysis" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Upload an image to scan for cybercrime content" })
            ] })
          ] }),
          !imageFile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "label",
            {
              ...
              style: {
                borderColor: dragOver ? DANGER_COLOR$1 : "rgba(33,50,71,0.8)",
                background: dragOver ? "rgba(249,115,22,0.05)" : "rgba(11,18,32,0.4)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    ...
                    onChange: (e) => {
                      var _a2;
                      if ((_a2 = e.target.files) == null ? void 0 : _a2[0]) handleFile(e.target.files[0]);
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 28, style: { color: DANGER_COLOR$1 } })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold mb-1", children: "Drop an image or click to browse" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "Supports PNG and JPEG files" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["PNG", "JPEG", "JPG"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 14, className: "text-gray-400" })
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-white font-medium", children: imageFile.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs", style: { color: "#9AAAC0" }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-16 h-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  borderTopColor: DANGER_COLOR$1,
                  borderRightColor: DANGER_COLOR$1
                }
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold", children: "Scanning Image for Crime" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "Running AI analysis on image content..." })
          ] })
        ]
      }
    ),
    result && ocrText && !loading && (() => {
      const isCrime = result.isBullying;
      const color = isCrime ? DANGER_COLOR$1 : SAFE_COLOR$1;
      const bgColor = isCrime ? "rgba(249,115,22,0.12)" : "rgba(0,200,150,0.12)";
      const borderColor = isCrime ? "rgba(249,115,22,0.45)" : "rgba(0,200,150,0.45)";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "image.result.panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: isCrime ? /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { size: 42, style: { color } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 42, style: { color } })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: { color },
                    children: isCrime ? "CYBERCRIME DETECTED" : "NO CRIME FOUND"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs mb-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#9AAAC0" }, children: "Crime Confidence Level" }),
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        ...
                        background: isCrime ? "linear-gradient(90deg, #C2410C, #F97316, #FB923C)" : "linear-gradient(90deg, #00A878, #00C896, #4DDBBA)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs mt-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4A6080" }, children: "0%" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4A6080" }, children: "100%" })
              ] })
            ]
          }
        ),
...
function DonutChart({ bullying, safe }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Detection Breakdown" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "circle",
            {
              cx,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "text",
            {
              ...
              fontSize: "22",
              fontWeight: "bold",
              children: (bullying + safe).toLocaleString()
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3 mt-1 w-full max-w-[200px]", children: segments.map((seg) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold", style: { color: seg.color }, children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full overflow-x-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: chartId }),
          yTicks.map((tick) => {
          ...
          data.map((group, gi) => {
            const groupX = paddingLeft + gi * barGroupWidth + barGroupWidth / 2 - keys.length * (barWidth + groupGap) / 2;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
              group.values.map((val, ki) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
                  ...
                  val > 0 && barH > 12 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "text",
                    {
                      x: x + barWidth / 2,
                      y: y - 2,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mt-2 justify-center", children: labels.map((lbl, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", style: { color: "#9AAAC0" }, children: lbl })
    ] }, lbl)) })
  ] });
}
function Reports({ stats, history: _history }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-white", children: "Analytics & Reports" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "#9AAAC0" }, children: "Detection trends and category breakdown" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", style: { color: DANGER_COLOR }, children: stats.bullyingDetected }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Bullying" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold", style: { color: SAFE_COLOR }, children: stats.safeMessages }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Safe" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-lg font-bold", style: { color: SAFE_COLOR }, children: [
                stats.accuracy,
                "%"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "#9AAAC0" }, children: "Accuracy" })
            ]
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2", children: Object.entries(CATEGORY_CONFIG).map(([key, cfg]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-bold", style: { color: cfg.color }, children: cfg.label.split("/")[0] })
      },
      key
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChartPie, { size: 16, style: { color: DANGER_COLOR } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Detection Breakdown" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              DonutChart,
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ChartNoAxesColumn, { size: 16, style: { color: "#A78BFA" } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Weekly Report (Last 7 Days)" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              GroupedBarChart,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { size: 16, style: { color: SAFE_COLOR } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Monthly Report (Last 4 Weeks)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            GroupedBarChart,
            {
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-semibold text-sm", children: "Most Flagged Words" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: TOP_BULLY_WORDS.map((item, idx) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-24 text-sm font-semibold text-white", children: item.word }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-2 rounded-full bg-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "h-full rounded-full transition-all",
                  style: {
...
function formatTimestamp() {
  ...
  return `${now2.getHours().toString().padStart(2, "0")}:${now2.getMinutes().toString().padStart(2, "0")}`;
}
function App() {
  const [page, setPage] = reactExports.useState("dashboard");
  const [isDark] = reactExports.useState(true);
  const [stats, setStats] = reactExports.useState(INITIAL_STATS);
  const [history, setHistory] = reactExports.useState([]);
  const [feed, setFeed] = reactExports.useState(ACTIVITY_FEED);
  const [sidebarOpen, setSidebarOpen] = reactExports.useState(false);
  const addAnalysis = (text, result, source) => {
    var _a2;
    const record = {
    ...
    setStats((prev) => ({
      ...
      accuracy: Number.parseFloat(
        ((prev.accuracy * prev.totalAnalyzed + (result.isBullying ? result.confidence : result.confidence)) / (prev.totalAnalyzed + 1)).toFixed(1)
      )
    }));
    const newItem = {
      id: record.id,
      ...
      category: (_a2 = result.flaggedWords[0]) == null ? void 0 : _a2.category,
      timestamp: "Just now",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "main",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-6", children: [
                page === "dashboard" && /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, { stats, feed, onNavigate: setPage }),
                page === "analyze" && /* @__PURE__ */ jsxRuntimeExports.jsx(AnalyzeMessage, { history, onAnalyze: addAnalysis }),
                page === "image" && /* @__PURE__ */ jsxRuntimeExports.jsx(ImageUpload, { onAnalyze: addAnalysis }),
                page === "reports" && /* @__PURE__ */ jsxRuntimeExports.jsx(Reports, { stats, history }),
                page === "helplines" && /* @__PURE__ */ jsxRuntimeExports.jsx(Helplines, {})
              ] })
            }
          )
        ] })
